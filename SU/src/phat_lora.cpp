...
// =====================================================
// RF CỐ ĐỊNH
// Bản này quay lại mục tiêu truyền thoại/đo khoảng cách; không đổi P_TX/SF runtime.
// =====================================================
static const int8_t CONG_SUAT_SU_DBM = CONG_SUAT_PHAT_SU_DBM;
